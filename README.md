...
In order to use this bot, create your own discord.js bot token, add your bot the discord server, and replace that token in the config.json file. Once that's complete you can execute the following command to run the project: 
